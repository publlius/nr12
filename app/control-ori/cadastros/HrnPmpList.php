...
class HrnPmpList extends TPage
{
    private $form; // form
    ...
    private static $activeRecord = 'HrnPmp';
    private static $primaryKey = 'id';
    private static $formName = 'formList_HrnPmp';
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle('Listagem de hrn pmp');
        ...
        $btn_onshow = $this->form->addAction('Cadastrar', new TAction(['HrnPmpForm', 'onShow']), 'fa:plus #69aa46');
        ...
        $action_onEdit = new TDataGridAction(array('HrnPmpForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('HrnPmpList', 'onDelete'));
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for HrnPmp
