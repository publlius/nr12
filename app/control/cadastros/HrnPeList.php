...
class HrnPeList extends TPage
{
    ...
    private static $activeRecord = 'HrnPe';
    private static $primaryKey = 'id';
    private static $formName = 'formList_HrnPe';
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle('Listagem de hrn pe');
        ...
        $btn_onshow = $this->form->addAction('Cadastrar', new TAction(['HrnPeForm', 'onShow']), 'fa:plus #69aa46');
        ...
        $action_onEdit = new TDataGridAction(array('HrnPeForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('HrnPeList', 'onDelete'));
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for HrnPe
