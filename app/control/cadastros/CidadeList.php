...
class CidadeList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $row3 = $this->form->addFields([new TLabel('Estado id:', null, '14px', null)],[$estado_id]);
        ...
        $btn_onshow = $this->form->addAction('Cadastrar', new TAction(['CidadeForm', 'onShow']), 'fa:plus #69aa46');
        ...
        $action_onDelete = new TDataGridAction(array('CidadeList', 'onDelete'));
        ...
        $container->add(TBreadCrumb::create(['Cadastros','Cidades']));
