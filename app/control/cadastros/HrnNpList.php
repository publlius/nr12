...
class HrnNpList extends TPage
{
    ...
    private static $activeRecord = 'HrnNp';
    private static $primaryKey = 'id';
    private static $formName = 'formList_HrnNp';
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle('Listagem de hrn np');
        ...
        $btn_onshow = $this->form->addAction('Cadastrar', new TAction(['HrnNpForm', 'onShow']), 'fa:plus #69aa46');
        ...
        $action_onEdit = new TDataGridAction(array('HrnNpForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('HrnNpList', 'onDelete'));
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for HrnNp
