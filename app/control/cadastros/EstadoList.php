...
class EstadoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle('Listagem de estados');
        ...
        $row3 = $this->form->addFields([new TLabel('Uf:', null, '14px', null)],[$uf]);
        ...
        $btn_onshow = $this->form->addAction('Cadastrar', new TAction(['EstadoForm', 'onShow']), 'fa:plus #69aa46');
        ...
        $action_onDelete = new TDataGridAction(array('EstadoList', 'onDelete'));
        ...
        $container->add(TBreadCrumb::create(['Cadastros','Estados']));
