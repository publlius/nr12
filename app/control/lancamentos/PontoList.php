...
class PontoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $column_apreciacao_equipamento_nome = new TDataGridColumn('{apreciacao->equipamento->nome}', 'Apreciacao', 'left');
        ...
        $this->datagrid->addColumn($column_apreciacao_equipamento_nome);
        ...
        $container->add(TBreadCrumb::create(['Lançamentos','Pontos']));
