...
class EquipamentoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $id = new TEntry('id');
        $empresa_unidade_id = new TDBCombo('empresa_unidade_id', 'nr12', 'EmpresaUnidade', 'id', '{descricao_unidade}','id asc'  );
        ...
        $row1 = $this->form->addFields([new TLabel('Id:', null, '14px', null)],[$id],[new TLabel('Unidade (filial):', null, '14px', null)],[$empresa_unidade_id]);
        ...
        $column_empresa_unidade_descricao_unidade = new TDataGridColumn('{empresa_unidade->descricao_unidade}', 'Unidade', 'left');
        ...
        $this->datagrid->addColumn($column_empresa_unidade_descricao_unidade);
    ...
    { 
        if(isset($param['delete']) && $param['delete'] == 1)
        {
            try
            {
                ...
                // instantiates object
                $object = new Equipamento($key, FALSE); //</blockLine>
