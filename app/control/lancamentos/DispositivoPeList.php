...
class DispositivoPeList extends TPage
{
    private $form; // form
    ...
    private static $formName = 'formList_DispositivoPe';
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle('Listagem de dispositivos pe');
        ...
        $btn_onshow = $this->form->addAction('Cadastrar', new TAction(['DispositivoPeForm', 'onShow']), 'fa:plus #69aa46');
        ...
        $column_apreciacao_id_apreciacao_equipamento_nome_apreciacao_equipamento_numero_serie = new TDataGridColumn('{apreciacao_id} - {apreciacao->equipamento->nome} -{apreciacao->equipamento->numero_serie}', 'Apreciacao id', 'left');
        ...
        $this->datagrid->addColumn($column_apreciacao_id_apreciacao_equipamento_nome_apreciacao_equipamento_numero_serie);

        $action_onEdit = new TDataGridAction(array('DispositivoPeForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('DispositivoPeList', 'onDelete'));
        ...
        $container->add(TBreadCrumb::create(['Lançamentos','Dispositivos PE']));
    ...
    { 
        if(isset($param['delete']) && $param['delete'] == 1)
        {
            try
            {
                ...
                // instantiates object
                $object = new DispositivoPe($key, FALSE); 
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for DispositivoPe
